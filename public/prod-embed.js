(() => {
    ...
    launcherHtml.innerHTML = `<div id="cex-bot-launcher" style="position: fixed; bottom: 3vh; right: 3vh; cursor: pointer; z-index: 10000;">
            ...
            <img id="cex-bot-launcher-img" style="position: fixed; bottom: 3vh; right: 3vh; border: 1px solid #1546a8; border-radius: 50%; padding: 5px; background-color: #ffffff; box-shadow: 2px 2px 4px black;" src="https://prodv3-hornblower-assets.s3.us-west-2.amazonaws.com/data/${siteid}Logo.png" width="50" height="50">
        </div>`;
