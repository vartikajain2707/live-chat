(() => {
    const body = document.body;
        ...
        launcherHtml.innerHTML = `<div id="cex-bot-launcher" style="position: fixed; bottom: 3vh; right: 3vh; cursor: pointer;">
            <iframe id="cex-chatbot" src="http://test-cityexperiences-bot.s3-website-us-west-2.amazonaws.com/" width="0" height="0" frameborder="0" style="border-radius: 15px; border: 1px solid lightgrey"></iframe>
