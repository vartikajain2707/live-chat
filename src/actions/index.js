...
export const clientEmailId = createAction('CLIENT_EMAILID')
export const prevResponse = createAction('PREV_RESPONSE')
export const totalMessageCount = createAction('TOTAL_MESSAGE_COUNT')
